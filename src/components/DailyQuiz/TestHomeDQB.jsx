...
const test_series_id = id.split("s")[1];
...
useEffect(()=>{
    const fetchdata = async()=>{
        const response = await axiosInstance.post(`/v1_data_model/courses/test_series/get_test_series_with_id/`,{"user_id":user_id,"test_series_id":test_series_id});
...
const handleStart = ()=>{
    if(checkstatus)
    {
        navigate(`/test-panel/dqb/${user_id}t${test_series_id}`);
    }
    else{
    setShowWarn(true);
    }
        ...
        <div className="container">
            <div className='testSeriesdata'>
                    ...
                    <table className="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>{testdata?.basic_info?.name}</td>
                ...
                <div className="startButton">
                    ...
                    <span class="btn btn-primary" id="startest" onClick={handleStart}>START TEST</span>
